...
for ph, f in [('/*DATA*/','data.js'),('/*DATA2*/','data_v2.js'),('/*DATAADV*/','data_advice.js'),('/*ENGINE*/','engine.js'),('/*ADVICE*/','advice.js'),('/*WEATHER*/','weather.js'),('/*STORE*/','store.js'),('/*SYNC*/','sync.js'),('/*UICORE*/','ui_core.js'),('/*UIRENDER*/','ui_render.js'),('/*UICARE*/','ui_care.js'),('/*UITREES*/','ui_trees.js'),('/*UISITE*/','ui_site.js'),('/*UICUSTOM*/','ui_custom.js'),('/*UIADVICE*/','ui_advice.js'),('/*UISYNC*/','ui_sync.js')]:
    t = t.replace(ph, rd(f))
...
(out/'config.js').write_text((d/'config.js').read_text())
