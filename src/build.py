...
for ph, f in [('/*DATA*/','data.js'),('/*DATA2*/','data_v2.js'),('/*ENGINE*/','engine.js'),('/*WEATHER*/','weather.js'),('/*STORE*/','store.js'),('/*UICORE*/','ui_core.js'),('/*UIRENDER*/','ui_render.js'),('/*UICARE*/','ui_care.js'),('/*UITREES*/','ui_trees.js'),('/*UISITE*/','ui_site.js'),('/*UICUSTOM*/','ui_custom.js')]:
    t = t.replace(ph, rd(f))
